...
const CareerStats = ({colors, tournament, onPress}) =>  {

    const winnings = 24340;
    const entryPaid = 13700;
    ...
    return(
        <View style={[styles.blockWrap]}>
            <TouchableOpacity style={[styles.block, colors.bkgWhite]} onPress={() => onPress(tournament.id)}>
                <Text style={[styles.blockHeader, styles.fontBold, colors.textBlack]}>CAREER STATISTICS</Text>

                <View style={[thisStyles.tBlocks]}>
                    <BlockCounter title='RANK' count='940th' golden={false}/>
                    <BlockCounter title='GAMES' count='531'/>
                    <BlockCounter title='AVG SCORE' count='284.6'/>
                    <BlockCounter title='TOTAL' count='23k'/>
                </View>
                <View style={[thisStyles.tBlocks, {marginTop:0,}]}>
                    <BlockCounter title='ATTENDED' count='208' golden={false}/>
